...
package uk.coko.forge.kokey.keyboard.internal;
...
import uk.coko.forge.kokey.latin.utils.XmlParseUtils;
import uk.coko.forge.kokey.latin.utils.XmlParseUtils.ParseException;
...
public class KeyboardBuilder<KP extends KeyboardParams> {
    ...
    private boolean parseCaseCondition(final XmlPullParser parser) {
        ...
        try {
            ...
            final boolean showEmojiKeyMatched = matchBoolean(caseAttr,
                    R.styleable.Keyboard_Case_showEmojiKey, id.mShowEmojiKey);
            final boolean selected = keyboardLayoutSetMatched && keyboardLayoutSetElementMatched
                    ...
                    && showMoreKeysMatched && showNumberRowMatched && showEmojiKeyMatched;
